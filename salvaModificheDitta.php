<?php
	...
	$query2="UPDATE cantiere_ditte SET nome='$nome', indirizzo='$indirizzo', localita='$localita', provincia='$provincia', cap='$cap', riferimento='$riferimento', telefono='$telefono', cellulare='$cellulare' WHERE id_ditta=$id_ditta";	
