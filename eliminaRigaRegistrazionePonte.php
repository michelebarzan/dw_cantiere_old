<?php
	...
	$queryOperatore="DELETE cantiere_ponti_ditte_registrazioni FROM cantiere_ponti_ditte_registrazioni WHERE registrazione = '$id_registrazione' AND ditta = '$id_ditta' AND ponte = '$ponte'";
